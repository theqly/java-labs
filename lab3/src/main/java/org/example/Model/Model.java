...
public class Model {
    ...
    public Model() {
        ...
        field.initMap(new File("/home/theqly/programming/projects/java-labs/lab3/src/main/resources/map.txt"));
        ...
        loadGhosts();
        records = loadRecords(new File("/home/theqly/programming/projects/java-labs/lab3/src/main/resources/score_board.txt"));
    ...
    private void saveRecord(double time){
        ...
        writeRecords(new File("/home/theqly/programming/projects/java-labs/lab3/src/main/resources/score_board.txt"));
    }
